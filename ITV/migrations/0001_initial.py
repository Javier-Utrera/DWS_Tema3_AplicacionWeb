    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ITV.cliente')),
            ],
        ),
        migrations.CreateModel(
            name='EstacionItv',
            fields=[
                ...
                ('cliente', models.ManyToManyField(through='ITV.Cita', to='ITV.cliente')),
                ('local', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='ITV.local')),
            ],
        ),
        migrations.AddField(
            model_name='cita',
            name='estacion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ITV.estacionitv'),
        ),
        migrations.CreateModel(
            name='Factura',
            fields=[
                ...
                ('inspeccion', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ITV.inspeccion')),
                ('resultado', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='Resultado_Inspeccion', to='ITV.inspeccion')),
            ],
        ),
        migrations.CreateModel(
            name='Maquinaria',
            fields=[
                ...
                ('idmpresaExterna', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ITV.empresaexterna')),
                ('iestacionItv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ITV.estacionitv')),
            ],
        ),
        migrations.CreateModel(
            name='Trabajador',
            fields=[
                ...
                ('observaciones', models.TextField()),
                ('estacion', models.ManyToManyField(to='ITV.estacionitv')),
                ('jefe', models.ManyToManyField(blank=True, related_name='subordinados', to='ITV.trabajador')),
            ],
        ),
        migrations.AddField(
            model_name='inspeccion',
            name='trabajador',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ITV.trabajador'),
        ),
        migrations.CreateModel(
            name='Vehiculo',
            fields=[
                ...
                ('matricula', models.CharField(max_length=7)),
                ('trabajadores', models.ManyToManyField(through='ITV.Inspeccion', to='ITV.trabajador')),
            ],
        ),
        migrations.AddField(
            model_name='inspeccion',
            name='vehiculo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ITV.vehiculo'),
        ),
    ]
