    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ITV.cliente')),
                ('id_estacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ITV.estacionitv')),
            ],
        ),
        migrations.CreateModel(
            name='Factura',
            fields=[
                ...
                ('id_inspeccion', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ITV.inspeccion')),
        ...
        migrations.AddField(
            ...
            name='id_local',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ITV.local'),
        ),
        migrations.CreateModel(
            name='Maquinaria',
            fields=[
                ...
                ('id_empresaExterna', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='ITV.empresaexterna')),
                ('id_estacionItv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ITV.estacionitv')),
            ],
        ),
        migrations.CreateModel(
            name='Trabajador',
            fields=[
                ...
                ('observaciones', models.TextField()),
                ('id_estacion', models.ManyToManyField(to='ITV.estacionitv')),
